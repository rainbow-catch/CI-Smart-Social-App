...
<?php endif; ?>
    <head>
        ...
        <?php endif; ?>
         ...
         <?php if($this->settings->info->enable_google_maps) : ?>
 <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $this->settings->info->google_maps_api_key ?>&libraries=places"></script>
