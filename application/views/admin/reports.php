...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_449") ?></li>
</ol>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_450") ?></td><td><?php echo lang("ctn_451") ?></td><td><?php echo lang("ctn_446") ?></td><td><?php echo lang("ctn_452") ?></td><td><?php echo lang("ctn_453") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#member-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/report_page") ?>",
            type : 'GET',
            data : function ( d ) {
