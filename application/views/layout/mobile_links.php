<div id="responsive-menu-links">
          ...
          <?php if($this->user->loggedin && isset($this->user->info->user_role_id) && 
           ...
           <?php if($this->user->info->admin || $this->user->info->admin_settings) : ?>
            ...
            <option value='<?php echo site_url("admin/page_categories") ?>'><?php echo lang("ctn_529") ?></option>
            <?php endif; ?>
            ...
            <option value='<?php echo site_url("admin/reports") ?>'><?php echo lang("ctn_530") ?></option>
            <?php endif; ?>
