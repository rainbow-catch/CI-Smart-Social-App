...
<ul class="settings-sidebar">
	...
	<li><span class="glyphicon glyphicon-question-sign"></span> <a href="<?php echo site_url("user_settings/change_security_question") ?>">Security Question</a></li>
	...
	<li><span class="glyphicon glyphicon-star"></span> <a href="<?php echo site_url("user_settings/ideology") ?>"><?php echo lang("ctn_850") ?></a></li>
