...
-- ----------------------------
INSERT INTO `site_settings` VALUES (1, 'Conspiracy', 'Conspiracy Or Not Conspiracy', 'E:\\PROJECT\\2OnGoingProject\\conOrNotCon\\Conspiracy-social-app\\uploads', 'uploads', 'test@test.com', 'logo.png', 0, 1, 'd/m/Y', 0, 'gif|png|jpg|jpeg', '', '', 0, '', '', '', '', 10028, '', 'USD', 1, '$', 0, 0, 1, 1, 5, 1, '', '', 0, '', '', 0, 'layout/themes/titan_layout.php', 1, 200, 200, 3600, '', '', 0, 0, 'Y/m/d H:i', 0, 0, 0, 0, 0, 1, 1, 1, 1, 5.40, 1, 1, 1, 1, 1, 0, 50, 1, 1, 0, '', 20, 3, 30, 3);
